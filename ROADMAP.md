...
**Progress note**: Ingest wires Pinata → `anchorSegment` → `video_records` (`ingest_segment_processor.py`) as of 2026-09-15. **US-6.6** still needs a live Amoy address from `npm run deploy:amoy`. See **CP-D.P1 / P3 / P4 / P6 / P7 / P8** Implemented; **CP-D.P2** Partial (backend calls the contract; testnet deploy is maintainer-run). **CP-D.P5 / P9** TBD.
...
| D | IPFS storage and blockchain anchoring | In progress — CP-D.P1 / P3 / P4 / P6 / P7 / P8 Implemented; CP-D.P2 Partial (live Amoy) |
